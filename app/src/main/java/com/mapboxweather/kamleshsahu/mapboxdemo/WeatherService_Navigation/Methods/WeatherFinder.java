...
import com.mapboxweather.kamleshsahu.mapboxdemo.WeatherService_Navigation.Interface.ApiInterface;
...
import static com.mapboxweather.kamleshsahu.mapboxdemo.WeatherService_Navigation.Constants.DarkskyKey;
...
//    }
   ...
   public void calcWeather(int id,double lat, double lng, String time){
        ...
        Retrofit retrofit= Retrofit_darksky_instance.getRetrofitInstance();
