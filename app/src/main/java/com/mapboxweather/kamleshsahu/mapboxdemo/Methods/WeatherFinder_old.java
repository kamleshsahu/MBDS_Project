...
//
//public class WeatherFinder_old {
//
//    double lat;
//    double lng;
//    String time;
...
//    long aft_distance;
//
//    public WeatherFinder_old(int pos, Point location, String time, LegStep step, long after_distance) {
...
//    }
//
//    public WeatherFinder_old(int pos, Point point, MatrixResponse matrixResponse, String time) {
//        this.pos=pos;
//        lat=point.latitude();
//        lng=point.longitude();
//        this.time=time;
